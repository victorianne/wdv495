        ...
        !function(p) {
                    ...
                    init: function(b, k, h, l, g) {
                        ...
                        return a.w(function() {
                            var q = a.a.c(k()),
                                n = !c != !q,
                                r = !x;
                            (r || d || n !== m) && (r && a.Z.oa() && (x = a.a.la(a.e.childNodes(b), !0)), n ? (r || a.e.T(b, a.a.la(x)), a.Ja(e ? e(g, q) : g, b)) : a.e.ma(b), m = n)
                        }, null, {
                            q: b
                        }), {
            ...
            a.b = function(b, d) {
                ...
                var f = {
                    ...
                    k = {},
                    h = {};
                k[M && /Firefox\/2/i.test(M.userAgent) ? "KeyboardEvent" : "UIEvents"] = ["keyup", "keydown", "keypress"], k.MouseEvents = "click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave".split(" "), b(k, function(a, b) {
                    if (b.length)
                ...
                return {
                    ...
                    ya: function(b, c) {
                        var g = a.a.m(b, c);
                        g > 0 ? b.splice(g, 1) : 0 === g && b.shift()
                    },
                    wb: function(b) {
                        b = b || [];
                        for (var c = [], g = 0, d = b.length; d > g; g++)
                            0 > a.a.m(c, b[g]) && c.push(b[g]);
                        return c
                    },
                    Ka: function(a, b) {
                        a = a || [];
                        for (var c = [], g = 0, d = a.length; d > g; g++)
                            c.push(b(a[g], g));
                        return c
                    },
                    xa: function(a, b) {
                    ...
                    Jb: function(b) {
                        b = a.a.O(b);
                        for (var c = (b[0] && b[0].ownerDocument || w).createElement("div"), g = 0, d = b.length; d > g; g++)
                            c.appendChild(a.S(b[g]));
                        return c
                    },
                    la: function(b, c) {
                        for (var g = 0, d = b.length, e = []; d > g; g++) {
                    ...
                    Qb: function(b, c) {
                        ...
                        if (0 < g.length) {
                            for (var d = g[0], e = d.parentNode, m = 0, f = c.length; f > m; m++)
                                e.insertBefore(c[m], d);
                            for (m = 0, f = g.length; f > m; m++)
                                a.removeNode(g[m])
                        }
                    },
                    na: function(a, b) {
                    ...
                    qa: function(b, c) {
                        ...
                        var g;
                        if ("input" === a.a.v(b) && b.type && "click" == c.toLowerCase() ? (g = b.type, g = "checkbox" == g || "radio" == g) : g = !1, u && !g)
                            u(b).trigger(c);
                    ...
                    Ha: function(b, c) {
                        ...
                        !d || 3 != d.nodeType || a.e.nextSibling(d) ? a.e.T(b, [b.ownerDocument.createTextNode(g)]) : d.data = g, a.a.mc(b)
                    },
                    Rb: function(a, b) {
                        if (a.name = b, 7 >= g)
                            try {
                    ...
                    mc: function(a) {
                        g >= 9 && (a = 1 == a.nodeType ? a : a.parentNode, a.style && (a.style.zoom = a.style.zoom))
                    },
                    kc: function(a) {
                        if (g) {
                            var b = a.style.width;
                    ...
                    zc: function(c, g, d) {
                        ...
                        if ("object" == typeof c && "form" === a.a.v(c))
                            for (var f = c.action, l = e.length - 1; l >= 0; l--)
                                for (var k = a.a.Db(c, e[l]), h = k.length - 1; h >= 0; h--)
                ...
                function d(c) {
                    ...
                    if (e)
                        for (var e = e.slice(0), l = 0; l < e.length; l++)
                            e[l](c);
                    if (a.a.f.clear(c), a.a.C.cleanExternalData(c), f[c.nodeType])
                ...
                a.a.ca = function(b, d) {
                    ...
                    if (a.a.Ra(b), d = a.a.c(d), null !== d && d !== p)
                ...
                function b(c, d) {
                    if (c)
                        if (8 == c.nodeType) {
                            ...
                            for (var f = 0, k = c.childNodes, h = k.length; h > f; f++)
                                b(k[f], d)
                }
                var d = {};
                return {
            ...
            }(), a.b("memoization", a.H), a.b("memoization.memoize", a.H.$a), a.b("memoization.unmemoize", a.H.Wb), a.b("memoization.parseMemoText", a.H.Lb), a.b("memoization.unmemoizeDomNodeAndDescendants", a.H.Xb), a.Sa = {
                ...
                rateLimit: function(a, d) {
                    var c,
                        e,
                        f;
                    "number" == typeof d ? c = d : (c = d.timeout, e = d.method), f = "notifyWhenChangesStop" == e ? S : R, a.Za(function(a) {
                        return f(a, c)
                    })
                },
                notify: function(a, d) {
            ...
            var z = {
                ...
                notifySubscribers: function(b, d) {
                    if (d = d || "change", "change" === d && this.Yb(), this.Ba(d))
                        try {
                            a.k.xb();
                            for (var f, c = this.G[d].slice(0), e = 0; f = c[e]; ++e)
                                f.Gb || f.La(b)
                        } finally {
                            a.k.end()
                        }
            ...
            a.D(z, "subscribe", z.U), a.D(z, "extend", z.extend), a.D(z, "getSubscriptionsCount", z.nc), a.a.za && a.a.Fa(z, Function.prototype), a.Q.fn = z, a.Hb = function(a) {
                ...
                function d() {
                    return 0 < arguments.length ? (d.Wa(c, arguments[0]) && (d.X(), c = arguments[0], d.W()), this) : (a.k.Ob(d), c)
                }
                var c = b;
                ...
                }, a.D(d, "peek", d.B), a.D(d, "valueHasMutated", d.W), a.D(d, "valueWillMutate", d.X), d
            }, a.r.fn = {
                equalityComparer: J
            };
            ...
            a.r.fn[H] = a.r, a.a.za && a.a.Fa(a.r.fn, a.Q.fn), a.Ta = function(b, d) {
            ...
            }, a.b("observable", a.r), a.b("isObservable", a.F), a.b("isWriteableObservable", a.Da), a.b("isWritableObservable", a.Da), a.ba = function(b) {
                if (b = b || [], "object" != typeof b || !("length" in b))
                ...
                replace: function(a, d) {
                    ...
                    c >= 0 && (this.X(), this.B()[c] = d, this.W())
                }
            }, a.a.o("pop push reverse shift sort splice unshift".split(" "), function(b) {
                a.ba.fn[b] = function() {
                    var a = this.B();
                    return this.X(), this.yb(a, b, arguments), a = a[b].apply(a, arguments), this.W(), a
                }
                    ...
                    b.ja = function(a) {
                        ...
                        if (c && !k) {
                            ...
                            case "splice":
                                ...
                                for (var r = 1 === v ? r : Math.min(d + (f[1] || 0), r), v = d + v - 2, t = Math.max(r, v), G = [], A = [], p = 2; t > d; ++d, ++p)
                                    r > d && A.push(l("deleted", b[d], d)), v > d && G.push(l("added", f[p], d));
                                a.a.Cb(A, G);
                                break;
                            default:
                                return
                ...
                function h() {
                    ...
                    a && a >= 0 ? (clearTimeout(z), z = setTimeout(function() {
                        l(!0)
                    }, a)) : g.nb ? g.nb() : l(!0)
                }
                function l(b) {
                ...
                var n,
                    ...
                    I = !1,
                    s = !1;
                if (A && "object" == typeof A ? (c = A, A = c.read) : (c = c || {}, A || (A = c.read)), "function" != typeof A)
                ...
                }), a.D(g, "peek", g.B), a.D(g, "dispose", g.p), a.D(g, "isActive", g.$), a.D(g, "getDependenciesCount", g.oa), D && (t = !0, D.nodeType && (y = function() {
                    return !a.a.Qa(D) || u && u()
                ...
                function b(a, f, k) {
                    if (k = k || new c, a = f(a), "object" != typeof a || null === a || a === p || a instanceof Date || a instanceof String || a instanceof Number || a instanceof Boolean)
                        return a;
                ...
                a.Vb = function(c) {
                    ...
                    save: function(b, c) {
                        ...
                        d >= 0 ? this.mb[d] = c : (this.keys.push(b), this.mb.push(c))
                    },
                    get: function(b) {
                        return b = a.a.m(this.keys, b), b >= 0 ? this.mb[b] : p
                    }
                }
                ...
                a.i = {
                    ...
                    Y: function(b, d, c) {
                        ...
                        case "option":
                            switch (typeof d) {
                            case "string":
                                a.a.f.set(b, a.d.options.ab, p), "__ko__hasDomDataOptionValue__" in b && delete b.__ko__hasDomDataOptionValue__, b.value = d;
                                break;
                            default:
                        ...
                        case "select":
                            "" !== d && null !== d || (d = p);
                            for (var h, e = -1, f = 0, k = b.options.length; k > f; ++f)
                                if (h = a.i.s(b.options[f]), h == d || "" == h && d === p) {
                                    e = f;
                                    break
                                }
                            (c || e >= 0 || d === p && 1 < b.size) && (b.selectedIndex = e);
                            break;
                        default:
                        ...
                        function m(b, g) {
                            ...
                            if (!r) {
                                ...
                                if (l && l.preprocess && !(g = l.preprocess(g, b, m)))
                                    return;
                                (l = h[b]) && (e = g, 0 <= a.a.m(d, e) ? e = !1 : (l = e.match(c), e = null === l ? !1 : l[1] ? "Object(" + l[1] + ")" + l[2] : e), l = e), l && k.push("'" + b + "':function(_z){" + e + "=_z}")
                            }
                ...
                var f = w && "<!--test-->" === w.createComment("test").text,
                ...
                a.e = {
                    ...
                    T: function(c, d) {
                        if (b(c)) {
                            a.e.ma(c);
                            for (var e = c.nextSibling, f = 0, l = d.length; l > f; f++)
                ...
                a.L = function() {
                    ...
                    parseBindingsString: function(b, d, c, e) {
                        try {
                            ...
                            if (!(h = f[k])) {
                                var l,
                                    g = "with($context){with($data||{}){return{" + a.h.Ea(b, e) + "}}}";
                ...
                function h(b, c, d) {
                    var e = !0,
                        f = 1 === c.nodeType;
                    f && a.e.Kb(c), (f && d || a.L.instance.nodeHasBindings(c)) && (e = g(c, null, b, d).shouldBindDescendants), e && !x[a.a.v(c)] && k(b, c, !f)
                }
                function l(b) {
                    var c = [],
                        d = {},
                ...
                a.getBindingHandler = function(b) {
                    ...
                    var m,
                        ...
                        l = a.j(function() {
                            var m = f ? b() : b,
                                h = a.a.c(m);
                            return c ? (c.K && c.K(), a.a.extend(e, c), l && (e.K = l)) : (e.$parents = [], e.$root = h, e.ko = a), e.$rawData = m, e.$data = h, d && (e[d] = h), g && g(e, c, h), e.$data
                        }, null, {
                            Pa: function() {
                                return m && !a.a.tb(m)
                            },
                ...
                a.Tb = function(b, c) {
                    ...
                    if (!u && y.jQuery && (u = y.jQuery), b && 1 !== b.nodeType && 8 !== b.nodeType)
                ...
                a.b("components.register", a.g.register), a.b("components.isRegistered", a.g.Xa), a.b("components.unregister", a.g.Ec), a.b("components.defaultLoader", a.g.Ab), a.g.loaders.push(a.g.Ab), a.g.$b = h
            }(), function() {
                function b(b, e) {
                ...
                a.d.component = {
                    init: function(f, k, h, l, g) {
                        ...
                        var x,
                            q,
                            n = a.a.O(a.e.childNodes(f));
                        return a.a.C.fa(f, m), a.w(function() {
                            var h,
                                t,
                                l = a.a.c(k());
                            if ("string" == typeof l ? h = l : (h = a.a.c(l.name), t = a.a.c(l.params)), !h)
            ...
            a.d.attr = {
                update: function(b, d) {
                    ...
                    a.a.A(c, function(c, d) {
                        ...
                        k && b.removeAttribute(c), 8 >= a.a.M && c in P ? (c = P[c], k ? b.removeAttribute(c) : b[c] = d) : k || b.setAttribute(c, d.toString()), "name" === c && a.a.Rb(b, k ? "" : d.toString())
                    })
                }
            }, function() {
                a.d.checked = {
            ...
            a.d.options = {
                ...
                update: function(b, d, c) {
                    ...
                    var q,
                        n = [];
                    m || (h ? n = a.a.Ka(e(), a.i.s) : 0 <= b.selectedIndex && n.push(a.i.s(b.options[b.selectedIndex]))), g && ("undefined" == typeof g.length && (g = [g]), q = a.a.xa(g, function(b) {
                    ...
                    d.beforeRemove = function(a) {
                        ...
                        return g.length && (n = !m && g[0].selected ? [a.i.s(g[0])] : [], r = !0), e = b.ownerDocument.createElement("option"), d === L ? (a.a.Ha(e, c.get("optionsCaption")), a.i.Y(e, p)) : (g = f(d, c.get("optionsValue"), d), a.i.Y(e, a.a.c(g)), d = f(d, c.get("optionsText"), g), a.a.Ha(e, d)), [e]
                    }, d, g), a.k.u(function() {
                ...
                a.d.textInput = {
                    init: function(b, c, l) {
                        ...
                        function k() {
                            var d = a.a.c(c());
                            null !== d && d !== p || (d = ""), w !== p && d === w ? setTimeout(k, 4) : b.value !== d && (u = d, b.value = d)
                        }
                        function v() {
                        ...
                        }), 8 == a.a.M && (h("keyup", t), h("keydown", t)), 8 <= a.a.M && (g(b, t), h("dragend", v))) : (h("input", t), 5 > e && "textarea" === a.a.v(b) ? (h("keydown", v), h("paste", v), h("cut", v)) : 11 > d ? h("keydown", v) : 4 > f && (h("DOMAutoComplete", t), h("dragdrop", t), h("drop", t))), h("change", t), a.w(k, null, {
                            q: b
                        })
                    }
                ...
                function e(b, e, f, h, q) {
                    ...
                    if (a.kb.lc(f, r, n), f = r.renderTemplate(f, h, q, n), "number" != typeof f.length || 0 < f.length && "number" != typeof f[0].nodeType)
                    ...
                    return n && (d(f, h), q.afterRender && a.k.u(q.afterRender, null, [f, h.$data])), f
                }
                function f(b, c, d) {
                ...
                a.d.template = {
                    ...
                    update: function(b, c, d, e, f) {
                        var r,
                            k = c();
                        c = a.a.c(k), d = !0, e = null, "string" == typeof c ? c = {} : (k = c.name, "if" in c && (d = a.a.c(c["if"])), d && "ifnot" in c && (d = !a.a.c(c.ifnot)), r = a.a.c(c.data)), "foreach" in c ? e = a.Cc(k || b, d && c.foreach || [], c, b, f) : d ? (f = "data" in c ? f.createChildContext(r, c.as) : f, e = a.eb(k || b, f, c, b)) : a.e.ma(b), f = e, (r = a.a.f.get(b, h)) && "function" == typeof r.p && r.p(), a.a.f.set(b, h, f && f.$() ? f : p)
                    }
                ...
                function b(b, c, e, f, k) {
                    var m,
                        ...
                        v = p + n + 1;
                    for (m = 0; p >= m; m++)
                        for (u = t, g.push(t = []), w = h(n, m + r), q = l(0, m - 1); w >= q; q++)
                            t[q] = q ? m ? b[m - 1] === c[q - 1] ? u[q - 1] : h(u[q] || v, t[q - 1] || v) + 1 : q + 1 : m + 1;
                    for (h = [], l = [], r = [], m = p, q = n; m || q;)
                ...
                function b(b, d, f, k, h) {
                    var l = [],
                        g = a.j(function() {
                            ...
                            0 < l.length && (a.a.Qb(l, g), k && a.k.u(k, null, [f, g, h])), l.length = 0, a.a.ia(l, g)
                        }, null, {
                            q: b,
                            Pa: function() {
                                return !a.a.tb(l)
                ...
                a.a.fb = function(c, e, f, k, h) {
                    ...
                    var m = a.a.f.get(c, d) === p,
                        ...
                        y = [];
                    e = [];
                    for (var s, D, E, z = [], q = [], C = 0; D = n[C]; C++)
                        switch (E = D.moved, D.status) {
                        case "deleted":
                            E === p && (s = u[v], s.j && s.j.p(), w.push.apply(w, a.a.na(s.aa, c)), k.beforeRemove && (e[C] = s, y.push(s))), v++;
                            break;
                        case "retained":
                            l(C, v++);
                            break;
                    ...
                    for (var H, C = 0, m = a.e.firstChild(c); s = y[C]; C++) {
                        for (s.aa || a.a.extend(s, b(c, f, s.wa, h, s.Ua)), v = 0; n = s.aa[v]; m = n.nextSibling, H = n, v++)
                            n !== m && a.e.Fb(c, n, H);
                ...
                return (d = (9 > a.a.M ? 0 : b.nodes) ? b.nodes() : null) ? a.a.O(d.cloneNode(!0).childNodes) : (b = b.text(), a.a.ca(b, e))
                ...
                a.Ya = function() {
                    ...
                    this.renderTemplateSource = function(b, e, f, k) {
                        ...
                        return h || (h = b.text() || "", h = u.template(null, "{{ko_with $item.koBindingContext}}" + h + "{{/ko_with}}"), b.data("precompiled", h)), b = [e.$data], e = u.extend({
                            koBindingContext: e
                        }, f.templateOptions), e = u.tmpl(h, b, e), e.appendTo(k.createElement("div")), u.fragments = {}, e
                    }, this.createJavaScriptEvaluatorBlock = function(a) {
                        return "{{ko_code ((function() { return " + a + " })()) }}"
                    }, this.addTemplate = function(a, b) {
                        w.write("<script type='text/html' id='" + a + "'>" + b + "</script>")
                    }, a > 0 && (u.tmpl.tag.ko_code = {
                        open: "__.push($1 || '');"
                    }, u.tmpl.tag.ko_with = {
                        open: "with($1) {",
                        close: "} "
